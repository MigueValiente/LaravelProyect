...
//   L.marker([37.405389, -5.936159],{draggable: true}).addTo(map).bindPopup('CC Zona Este').openPopup();
...
//Creamos un puntero señalando por ejemplo el Zona este
  L.marker([37.405389, -5.936159],{icon: defaultIcon},{draggable: true}).addTo(map).bindPopup('CC Zona Este').openPopup();
